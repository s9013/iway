...
requirejs([
			...
			function($,Masonry){
			    ...
			    for ( var i = 0; i < 33; i++ ) {
			         html += '<div class="item"><div class="pic"><img src="images/m'+i+'.jpg" > </div> <div class="text">hello! how are you ?</div>  </div>';
			    }
			    $('#container').html(html);
			...
			function addItems(){
			      ...
			      for ( var i = 0; i < 33; i++ ) {
			        var elem = $('<div class="item"><div class="pic"><img src="images/m'+i+'.jpg" > </div> <div class="text">hello! how are you ?</div></div>')[0] //getItemElement();
